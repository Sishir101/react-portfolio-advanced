...
function Hero() {
  ...
  <div className="absolute -bottom-40 -right-40 h-[500px] w-[500px] sm:h-[700px] sm:w-[700px] rounded-full bg-purple-600/30 blur-[160px] sm:blur-[220px]" />
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-10 sm:gap-16 px-5 sm:px-6 md:px-8 lg:grid-cols-2 py-12 sm:py-16 pt-28 sm:pt-32">
        {/* Left */}
        <motion.div
