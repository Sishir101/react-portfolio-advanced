...
function Projects() {
  ...
  return (
    <section id="projects" className="relative scroll-mt-24 bg-[#0B1120] py-24 sm:py-28">
      <div className="relative mx-auto max-w-7xl px-6 md:px-8">
        ...
        {error && (
          <p className="mb-8 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-200 leading-relaxed">
        ...
        {!loading && projects.length === 0 && (
          <p className="text-center text-slate-400 py-16 leading-relaxed">
